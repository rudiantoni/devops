...
@REM 
@REM If you want to create a rollback for this migration, use the create_migration_and_rollback.bat script instead.
@REM If you want to change the output directory, change MIGRATION_OUTPUT_FOLDER.
@REM 
