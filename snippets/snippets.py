...
# In Python, data structures types often called objects, are equivalent to dictionaries.
...
print()
print('# Using inline if (pseudo-ternary), if-else to run functions')
print('--------------------------------------------------')
...
print()
print('# Using inline if (pseudo-ternary), if-else to return values')
print('--------------------------------------------------')
...
print()
print('# Looping through an dictionary keys')
print('--------------------------------------------------')
...
print('# Transform a string in lowercase')
print('--------------------------------------------------')
lower_string = 'APPLE'
print(lower_string.lower()) # Output: apple

print('# Transform a string in uppercase')
print('--------------------------------------------------')
upper_string = 'apple'
...
print('# Create an array from a range of indexes from another array')
print('--------------------------------------------------')
...
print()
print('# Assigning values to each list/nparray position')
print('--------------------------------------------------')
list_assign = [1, 2, 3]
...
print()
print('# Mapping dictionaries with name and country keys')
print('--------------------------------------------------')
people_map = [
...
print()
print('# Unpacking dictionaries (python 3.5+)')
print('--------------------------------------------------')
